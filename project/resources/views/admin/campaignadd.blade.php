                                ...
                                <div class="add-product-box">
                                    ...
                                    <form method="POST" action="{!! action('CampaignController@store') !!}" id="add_form" class="form-horizontal"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" name="description" id="update_campaign_description" rows="5" placeholder="Campaign Description" style="resize: vertical;"  required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
