                                ...
                                <div class="add-product-box">
                                    ...
                                    <form method="POST" action="{!! action('TestimonialController@update',['id'=>$testimonial->id]) !!}" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea name="review" id="clients_review" class="form-control" placeholder="review text" style="resize: vertical;" required>{{$testimonial->review}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="clients_name">Client's Name*</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="client" id="clients_name" value="{{$testimonial->client}}" placeholder="e.g John" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
